...
public class practica {
	public static void main(String[] args) {
		...
		try {
			...
			String usuario = "root";
			String password = "";
			String urlBBDD = "jdbc:mysql://localhost:3306/bd_videoclub?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
